...
let consiglio = document.getElementById("advice1");
let computer = false;
let scoreX = 0;
let scoreO = 0;
function handleOnClickField(id) {
    ...
    if (computer) {
        ...
        document.getElementById("f" + computerInput).value = "O";
        _isTris();
    }
    _changePlayer();
}
...
function _detectGenericWinner(field1, field2, field3) {
    return _detectWinner(field1, field2, field3, "X") || _detectWinner(field1, field2, field3, "O");
}
function _detectWinner(field1, field2, field3, type) {
